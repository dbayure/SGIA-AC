...
/**
 * Clase utilizada para atender pedidos REST y devolver un recurso web de un Rol para ser utilizado en la vista
 */
@Path("/roles")
@RequestScoped
public class RolResourceRESTService {
	...
	public List<Rol> listAll() {
		...
		final List<Rol> results = em.createQuery(
				"select c from Rol c order by c.id").getResultList();
		return results;
	}
