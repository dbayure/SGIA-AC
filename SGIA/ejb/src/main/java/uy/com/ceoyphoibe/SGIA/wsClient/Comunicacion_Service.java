 ...
 * 2014-12-16T21:23:33.903-02:00
 * Generated source version: 2.4.6
 * 
 */
@WebServiceClient(name = "Comunicacion", 
                  wsdlLocation = "http://192.168.0.104:7789/?wsdl",
...
public class Comunicacion_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.0.104:7789/?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Comunicacion_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.0.104:7789/?wsdl");
        }
        WSDL_LOCATION = url;
    }
