...
public class ClientSample {
	...
	public static void main(String[] args) {
	        ...
	        System.out.println("Server said: " + port1.wsObtenerEstadoAlertaPlaca(null));
	        //Please input the parameters instead of 'null' for the upper method!
	
	        System.out.println("Server said: " + port1.wsActualizarGrupoActuadores(null,null,null));
	        //Please input the parameters instead of 'null' for the upper method!
	
	        System.out.println("Server said: " + port1.wsObtenerPosicionActuadorAvance(null));
	        //Please input the parameters instead of 'null' for the upper method!
	        ...
	        System.out.println("Server said: " + port1.wsObtenerEstadoGrupoActuadores(null));
	        //Please input the parameters instead of 'null' for the upper method!
	
	        System.out.println("Server said: " + port1.wsEliminarGrupoActuadores(null));
	        //Please input the parameters instead of 'null' for the upper method!
	
	        System.out.println("Server said: " + port1.wsObtenerEstadoAlertaDispositivo(null));
	        //Please input the parameters instead of 'null' for the upper method!
	        ...
	        System.out.println("Server said: " + port1.wsObtenerEstadoActuador(null));
	        //Please input the parameters instead of 'null' for the upper method!
	        ...
	        System.out.println("Server said: " + port2.wsObtenerEstadoAlertaPlaca(null));
	        //Please input the parameters instead of 'null' for the upper method!
	
	        System.out.println("Server said: " + port2.wsActualizarGrupoActuadores(null,null,null));
	        //Please input the parameters instead of 'null' for the upper method!
	
	        System.out.println("Server said: " + port2.wsObtenerPosicionActuadorAvance(null));
	        //Please input the parameters instead of 'null' for the upper method!
	        ...
	        System.out.println("Server said: " + port2.wsObtenerEstadoGrupoActuadores(null));
	        //Please input the parameters instead of 'null' for the upper method!
	
	        System.out.println("Server said: " + port2.wsEliminarGrupoActuadores(null));
	        //Please input the parameters instead of 'null' for the upper method!
	
	        System.out.println("Server said: " + port2.wsObtenerEstadoAlertaDispositivo(null));
	        //Please input the parameters instead of 'null' for the upper method!
	        ...
	        System.out.println("Server said: " + port2.wsObtenerEstadoActuador(null));
	        //Please input the parameters instead of 'null' for the upper method!
