...
public class TipoLogEventoListProducer {
   ...
   public void onListChanged(@Observes(notifyObserver = Reception.IF_EXISTS) final TipoLogEvento tipoLogEvento) {
   ...
   public void retrieveAllOrderedByName() {
      ...
      CriteriaQuery<TipoLogEvento> criteria = cb.createQuery(TipoLogEvento.class);
      Root<TipoLogEvento> tipoLogEvento = criteria.from(TipoLogEvento.class);
      criteria.select(tipoLogEvento).orderBy(cb.asc(tipoLogEvento.get("nombre")));
