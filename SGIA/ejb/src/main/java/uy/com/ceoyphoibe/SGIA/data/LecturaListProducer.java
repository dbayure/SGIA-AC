...
public class LecturaListProducer {
   ...
   public void onListChanged(@Observes(notifyObserver = Reception.IF_EXISTS) final Lectura lectura) {
	      retrieveAllOrderedByName();
   }
   
   public List<Lectura> getLecturasIdSensorEntreFechas(Long idDispositivo, Timestamp min, Timestamp max) 
   {
