...
/**
 * <p>
 * Java class for wsCrearSensor complex type.
 * 
 * <p>
...
@XmlType(name = "wsCrearSensor", propOrder = { "nombre", "modelo", "nroPuerto",
		"formulaConversion", "idTipoPuerto", "idPlacaPadre", "idFactor" })
