...
public class TipoActuadorListProducer {
   ...
   public void onListChanged(@Observes(notifyObserver = Reception.IF_EXISTS) final TipoActuador tipoActuador) {
   ...
   public void retrieveAllOrderedByName() {
      ...
      CriteriaQuery<TipoActuador> criteria = cb.createQuery(TipoActuador.class);
      Root<TipoActuador> tipoActuador = criteria.from(TipoActuador.class);
      criteria.select(tipoActuador).orderBy(cb.asc(tipoActuador.get("categoria")));
