...
/**
 * <p>
 * Java class for wsCrearActuadorAvance complex type.
 * 
 * <p>
...
@XmlType(name = "wsCrearActuadorAvance", propOrder = { "nombre", "modelo",
		"nroPuerto", "posicion", "idTipoPuerto", "idTipoActuador",
		"idPlacaPadre", "nroPuertoRetroceso", "tipoPuertoRetroceso",
